...
namespace Marvin.Pipelines
{
    public class Publish : Pipeline, INamedPipeline
    {
        ...
        public Publish(ProjectSet projectSet)
        {
            ...
            {
                new ThrowExceptionIf(Config.ContainsSettings(Settings.NuGetApiKey).IsFalse(), $"{Settings.NuGetApiKey} setting missing"),
                new ThrowExceptionIf(Config.ContainsSettings(Settings.GitHubToken).IsFalse(), $"{Settings.GitHubToken} setting missing"),
                ...
                new StartProcess("nuget")
                    ...
                    .WithArgument("-ApiKey", Config.FromSetting(Settings.NuGetApiKey), true)
